...
// Handler - wraps a http.Handler along with a logger associated with it.
type Handler struct {
	handler http.Handler
	logger  *logger.Logger
}

// NewHandler - create instance of Handler with supplied http.Handler and logger.Logger
...
// ServeHTTP - handles http request coming to this Handler
