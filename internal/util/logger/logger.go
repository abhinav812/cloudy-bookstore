...
// Logger - struct wrapper around zerolog logger
type Logger struct {
	logger *zerolog.Logger
}

// New - creates new Logger based on Debug parameter.
// Debug=false, will return Logger with log lever as INFO.
// Output to StdErr
...
//NewConsole - creates new Logger based on Debug parameter.
//// Debug=false, will return Logger with log lever as INFO.
//// Output to StdOut
